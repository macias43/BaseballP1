predict future season stats for baseball players using machine learning.  The stat predicts the wins above replacement (WAR) a player will generate next season. 
